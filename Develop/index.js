...
const questions = [
    ...
    },
    {
        ...
        name: 'sections',
        message:
            'What sections do you wish to include? (check all to be included)',
    ...
    },
    {
        ...
        message:
            'Do you wish to use the Contributor Covenant or create your own contributing section?',
    ...
    },
    {
        ...
        message:
            ...
            'Input allows Markdown formatting.\n' +
            'Formatting exceptions: use <br> for linebreaks \nand <br><br> for paragraph breaks.\n',
